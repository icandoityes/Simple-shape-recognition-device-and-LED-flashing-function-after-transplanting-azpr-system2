...
HD_PWD='D:/FPGA learning/SEA-master/SEA-master/Examples/FPGA/4.Module-Interface/MIPI-Camera-Interface/Image_Demo/Image_Demo.runs/csi2_d_phy_rx_0_synth_1'
cd "$HD_PWD"
