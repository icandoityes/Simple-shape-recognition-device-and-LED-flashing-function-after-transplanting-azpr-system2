...
HD_PWD='D:/FPGA learning/SEA-master/SEA-master/Examples/FPGA/4.Module-Interface/MIPI-Camera-Interface/Image_Demo/Image_Demo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Image_Demo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Image_Demo.tcl
