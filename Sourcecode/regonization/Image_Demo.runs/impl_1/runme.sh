...
HD_PWD='D:/FPGA learning/SEA-master/SEA-master/Examples/FPGA/4.Module-Interface/MIPI-Camera-Interface/Image_Demo/Image_Demo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Image_Demo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Image_Demo.tcl -notrace
